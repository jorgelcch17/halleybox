    ...
    <div class="container py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    <p class="text-neutral-700">Marca: <a class="underline capitalize hover:text-orange-500">{{$product->brand->name}}</a></p>
                ...
                <p class="text-2xl font-semibold text-neutral-700 my-4">US$ {{$product->price}}</p>
