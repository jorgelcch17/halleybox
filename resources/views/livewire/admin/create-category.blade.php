<div>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aquí encontrará todas las categorias agregadas
        </x-slot>
        <x-slot name="content">
    ...
    <x-jet-dialog-modal wire:model="editForm.open">
        ...
        <x-slot name="content">
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <input wire:model="editImage" accept="image/*" type="file" class="mt-1"
                        id="{{ $rand }}">
        ...
        <x-slot name="footer">
            <x-jet-danger-button wire:loading.attr="disabled" wire:target="editImage, update" wire:click="update">
                Actualizar
            </x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>
